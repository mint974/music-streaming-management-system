...
<head>
    ...
    <style>
        ...
        .detail-value.highlight { color: #34d399; }
...
<div class="wrapper">
    <div class="card">
        <div class="header">
            ...
            <p>Yêu cầu cập nhật email tài khoản của bạn</p>
        </div>

        <div class="body">
            <p class="greeting">
                Xin chào <strong style="color:#a5b4fc">{{ $user->name }}</strong>,<br>
                Chúng tôi nhận được yêu cầu thay đổi email cho tài khoản Blue Wave Music của bạn.
                Vui lòng xác nhận thay đổi bên dưới.
            </p>

            <div class="info-box">
                <div class="detail-row">
                    <span class="detail-label">Email hiện tại</span>
                    <span class="detail-value">{{ $user->email }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Email mới</span>
                    <span class="detail-value highlight">{{ $newEmail }}</span>
                </div>
            </div>
            ...
            <div class="warning-box">
                <p class="warning-text">
                    ...
                    Email hiện tại của bạn sẽ không bị thay đổi.
                </p>
            </div>

            <p class="message">
                Sau khi xác nhận, email đăng nhập của bạn sẽ được cập nhật sang
                <strong style="color:#34d399">{{ $newEmail }}</strong>.
                Bạn sẽ cần xác minh lại email mới.
            </p>

            <div style="text-align:center;">
                <a href="{{ $verificationUrl }}" class="btn">Xác nhận thay đổi email</a>
            </div>
