...
<div class="wrapper">
    <div class="card">
        <div class="header">
            ...
            <p>Yêu cầu khôi phục mật khẩu tài khoản</p>
        </div>

        <div class="body">
            <p class="greeting">
                Xin chào <strong style="color:#a5b4fc">{{ $user->name }}</strong>,<br>
                Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản Blue Wave Music của bạn.
            ...
            <p class="message">
                Bấm nút bên dưới để được chuyển đến trang tạo mật khẩu mới.
